...
class CatalogoActivity : AppCompatActivity() {
    ...
    fun cargarPeliculas(){
        ...
        peliculas.add(Pelicula("Héroe Por Encargo", R.drawable.heroe_x_encargo, R.drawable.heroe_encargo, "Un ex agente de las fuerzas especiales acepta un trabajo para brindar seguridad a una periodista mientras entrevista a un dictador, pero estalla un golpe militar en medio de la entrevista y se ven obligados a escapar a la jungla donde deben sobrevivir.", arrayListOf<Cliente>()))
        ...
        peliculas.add(Pelicula("Vidas Pasadas", R.drawable.vidaspasadas, R.drawable.vidas_pasada, "Nora y Hae Sung, dos amigos de la infancia profundamente unidos, son separados después de que la familia de Nora emigrara de Corea del Sur. Veinte años después, se reúnen durante una fatídica semana para enfrentarse al amor y al destino.", arrayListOf<Cliente>()))
    }
    ...
    fun cargarSeries(){
        ...
        series.add(Pelicula("El Monstruo de la Vieja Seúl", R.drawable.el_monstruo, R.drawable.el_monstruo_vieja, "Gyeongseong, 1945. En la oscura era colonial de Seúl, un empresario y una investigadora luchan por sobrevivir y se enfrentan a un monstruo nacido de la avaricia humana.", arrayListOf<Cliente>()))
    ...
    class PeliculaAdapter: BaseAdapter{
        ...
        override fun getItem(p0: Int) = peliculas[p0]
        ...
        override fun getView(
            ...
            val vista = inflator.inflate(R.layout.activity_pelicula, null)
            val image: ImageView = vista.findViewById(R.id.image_movie)
            val title: TextView = vista.findViewById(R.id.movie_title)
